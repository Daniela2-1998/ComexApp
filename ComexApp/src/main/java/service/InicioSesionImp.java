 ...
 * @author Daniela
 */
public class InicioSesionImp implements InicioSesionService{
   ...
   public Usuarios agregarUsuario(Integer id, String usuario, String contraseña, String nombre, 
       ...
       if(avanzar == 0){
           try{
               ...
               pst.setString(9, statusReal);
               pst.setDate(10, diaActual);
    ...
    public boolean verificarQueNoExistaUsuario(String usuario){
        ...
        Boolean noExiste = null;
        try{
            conec = cn.Conexion();
            pst = conec.prepareStatement("select usuario from usuarios where "
                    + "usuario = '" + usuario + "'");
            rs = pst.executeQuery();
            
            if(rs.next()){
                noExiste = false;
                JOptionPane.showMessageDialog(null, "Ya existe un usuario con el nombre " + usuario);
            } else{
                noExiste = true;
            }
            conec.close();
    ...
    public static void setUsuario(String usuario) {
        InicioSesionImp.usuario = usuario;
    }
    ...
    public static void setContraseña(String contraseña) {
        InicioSesionImp.contraseña = contraseña;
    }
    ...
    public static void setApellido(String apellido) {
        InicioSesionImp.apellido = apellido;
    }
    ...
    public static void setRolCorrespondiente(String rolCorrespondiente) {
        InicioSesionImp.rolCorrespondiente = rolCorrespondiente;
    }
