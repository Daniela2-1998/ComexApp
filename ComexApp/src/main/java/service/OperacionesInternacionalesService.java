 ...
 * @author Daniela
 */
public class OperacionesInternacionalesService implements OperacionesInternacionalesImpl{
    ...
    public boolean ingresoOperacionInternacional(int ID, int cantidadContenedor,
            ...
            String paisOrigen, String nombreBuque, String fechaOperacion, String fechaETA){
       ...
       if(comprador.equals("")){
        ...
        if(avanzar == 0){
            try{
                ...
                pst.setString(15, fechaOperacion);
                pst.setString(16, fechaETA);
                ...
                JOptionPane.showMessageDialog(null, "Se añadió una nueva operación "
                        ...
                        vendedor + " \n\n que llegaría el día " + fechaETA + " en el contenedor " 
     ...
     public void detallesTablasExtraMaritimas(int IDOperacion, int IDMaritima,
       ...
       public void modificarOperacionInternacional(int IDMod, int cantidadContenedorMod,
        ...
        String sql = "update operaciones set id_operaciones=?, cantidad_contenedores=?, "
                ...
                + "nombre_buque=?, fecha_operacion=?, fecha_eta=? where producto = '" 
                + producto + "'";
        ...
        try {
            ...
            if (alternativaMensaje == 0) {
                ...
                pst.setString(15, fechaOperacionMod);
                pst.setString(16, fechaETAMod);
