 ...
 * @author Daniela
 */
public class InformacionIDAgenda extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDAgenda
     */
    public InformacionIDAgenda() {
        initComponents();
        ...
        setTitle("ID´s agenda inscriptos - sistema ComexApp");
    ...
    public void cargarTablaIDs(){
        ...
        String sql = "select id_agenda from agenda_personal order by id_agenda asc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDAgenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDAgenda().setVisible(true);
            }
        });
    }
