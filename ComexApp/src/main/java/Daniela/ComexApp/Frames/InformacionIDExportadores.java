 ...
 * @author Daniela
 */
public class InformacionIDExportadores extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDExportadores
     */
    public InformacionIDExportadores() {
        initComponents();
        ...
        setTitle("ID´s de exportadores inscriptos - sistema ComexApp");
    ...
    public void cargarTablaIDs(){
        ...
        String sql = "select id_exportador from exportadores order by id_exportador asc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDExportadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDExportadores().setVisible(true);
            }
        });
    }
