 ...
 * @author Daniela
 */
public class InformacionIDOperacionInternacional extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDOperacionInternacional
     */
    public InformacionIDOperacionInternacional() {
        initComponents();
        ...
        setTitle("ID´s operación inscriptos - sistema ComexApp");
    ...
    public void cargarTablaIDs(){
        ...
        String sql = "select id_operaciones from operaciones order by id_operaciones asc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDOperacionInternacional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDOperacionInternacional().setVisible(true);
            }
        });
    }
