 ...
 * @author Daniela
 */
public class InformacionIDDespachantes extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDDespachantes
     */
    public InformacionIDDespachantes() {
        initComponents();
        ...
        setTitle("ID´s de despachantes inscriptos - sistema ComexApp");
    ...
    public void cargarTablaIDs(){
        ...
        String sql = "select id_despachantes from despachantes order by id_despachantes asc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDDespachantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDDespachantes().setVisible(true);
            }
        });
    }
