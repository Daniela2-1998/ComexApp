 ...
 * @author Daniela
 */
public class TengoContraseña extends javax.swing.JFrame {
 
    public String contraseña = "", nombre = "";
    /**
     * Creates new form TengoContraseña
     *  PARA RECUPERAR USUARIO A PARTIR DE UNA CONTRASEÑA Y PREGUNTAS DE SEGURIDAD
     */
    public TengoContraseña() {
        initComponents();
        ...
        setTitle("Recupero de usuario - sistema ComexApp");
    }
    ...
    String usuario = usuariosImpl.obtenerUsuario(nombre, contraseña);
    ...
    private void initComponents() {
        ...
        jPanel2.add(textContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 170, 110, -1));
    ...
    private void jButtonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmarActionPerformed
        ...
        String preguntaUno, preguntaDos, preguntaTres, preguntaUnoC, preguntaDosC, 
                preguntaTresC, contraseña, nombre;
        ...
        if(preguntaUno.equals(preguntaUnoC) && preguntaDos.equals(preguntaDosC) 
            ...
            int IDUsuario = usuariosImpl.obtenerIDUsuario(usuario);
            
            String pregunta = "¿Este es tu ID?: " + IDUsuario;
            String botones[] = {"Es mi ID", "No es mi ID"};
       
            int preguntaID = JOptionPane.showOptionDialog(null, pregunta,
                "Confirmación de ID", 0, 0, null, botones, this);
            
            if (preguntaID == JOptionPane.YES_OPTION){
                JOptionPane.showMessageDialog(null, nombre + " tu usuario es " 
                        + usuario, "Recuperación de usuario", 0);
            } else if (preguntaID == JOptionPane.NO_OPTION){
                JOptionPane.showMessageDialog(null, "No es posible recuperar tu "
                        + "nombre de usuario.", "Error al obtener tu usuario", 1);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TengoContraseña.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TengoContraseña().setVisible(true);
            }
        });
    }
