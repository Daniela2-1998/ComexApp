 ...
 * @author Daniela
 */
public class InformacionIDMaritimas extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDMaritimas
     */
    public InformacionIDMaritimas() {
        initComponents();
        ...
        setTitle("ID´s de marítimas inscriptos - sistema ComexApp");
    ...
    public void cargarTablaIDs(){
        ...
        String sql = "select id_maritima from maritimas order by id_maritima asc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDMaritimas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDMaritimas().setVisible(true);
            }
        });
    }
