 ...
 * @author Daniela
 */
public class InformacionIDReabastecimiento extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDReabastecimiento
     */
    public InformacionIDReabastecimiento() {
        initComponents();
        ...
        setTitle("ID´s reabastecimiento inscriptos - sistema ComexApp");
    ...
    public void cargarTablaIDs(){
        ...
        String sql = "select id_pedido from reabastecimiento order by id_pedido asc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDReabastecimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDReabastecimiento().setVisible(true);
            }
        });
    }
