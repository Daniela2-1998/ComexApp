 ...
 * @author Daniela
 */
public class InformacionIDMensajeObjetivo extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDMensajeObjetivo
     */
    public InformacionIDMensajeObjetivo() {
        initComponents();
        ...
        setTitle("ID´s mensajes - sistema ComexApp");
    ...
    public void cargarTablaIDs(){
        ...
        String sql = "select id_mensaje_objetivo from mensajes_objetivos order by id_mensaje_objetivo asc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDMensajeObjetivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDMensajeObjetivo().setVisible(true);
            }
        });
    }
