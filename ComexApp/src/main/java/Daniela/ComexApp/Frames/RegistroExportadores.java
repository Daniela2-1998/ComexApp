 ...
 * @author Daniela
 */
public class RegistroExportadores extends javax.swing.JFrame {

    String usuario = "", nombreCompleto = "";
    /**
     * Creates new form RegistroImportadores
     */
    public RegistroExportadores() {
        initComponents();
        ...
        setTitle("Registro de exportadores - " + usuario + " - sistema ComexApp");
    }
       // icono
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Registro de exportadores");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/export11.png"))); // NOI18N
        jLabel1.setText("EXPORT");
        jLabel1.setToolTipText("");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanelCampos.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 290, 230, 200));
    ...
    private void jButtonRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistroActionPerformed
        ...
        if(recepcion.equals(true)){
           LimpiarCamposRegistroExportadores();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroExportadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroExportadores().setVisible(true);
            }
        });
    }
