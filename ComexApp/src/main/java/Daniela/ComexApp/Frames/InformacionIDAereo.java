...
public class InformacionIDAereo extends javax.swing.JFrame {
    ...
    public InformacionIDAereo() {
        ...
        setTitle("ID´s de aerolíneas inscriptos - sistema ComexApp");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDAereo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDAereo().setVisible(true);
            }
        });
    }
