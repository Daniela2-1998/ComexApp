 ...
 * @author Daniela
 */
public class ListaExportadores extends javax.swing.JFrame {

    String usuario = "", nombreCompleto = "";
    /**
     * Creates new form ListaImportadores
     */
    public ListaExportadores() {
        initComponents();
        ...
        setTitle("Lista de exportadores - Sistema ComexApp");
    ...
    public void cargarTablaExportadores(String sql){
        ...
        try{
            ...
            jTableExportadores = new JTable(modelo);
            jScrollPane1.setViewportView(jTableExportadores);
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar tabla de exportadores");
            System.err.println("Error al cargar tabla de exportadores " + e);
        }
    }
    ...
    private void initComponents() {
        ...
        jTableExportadores = new javax.swing.JTable();
        ...
        jLabelTitulo.setText("Lista de exportadores");
        ...
        jLabelFijo.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabelFijo.setForeground(new java.awt.Color(0, 0, 153));
        jLabelFijo.setText("Lista completa de exportadores");
        jPanelOpciones.add(jLabelFijo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 340, -1));

        jLabelPersonalizado.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabelPersonalizado.setForeground(new java.awt.Color(0, 0, 153));
        jPanelOpciones.add(jLabelPersonalizado, new org.netbeans.lib.awtextra.AbsoluteConstraints(13, 60, 330, 27));

        jButtonVolver1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButtonVolver1.setForeground(new java.awt.Color(0, 0, 153));
        jButtonVolver1.setText("Información exportador");
        ...
        jTableExportadores.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        jTableExportadores.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
    ...
    private void jButtonVolver1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVolver1ActionPerformed
        ...
        InformacionExportador infoExportador = new InformacionExportador();
        infoExportador.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaExportadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaExportadores().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableExportadores;
