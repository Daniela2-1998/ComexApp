 ...
 * @author Daniela
 */
public class InformacionIDObjetivo extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDObjetivo
     */
    public InformacionIDObjetivo() {
        initComponents();
        ...
        setTitle("ID´s de objetivos - sistema ComexApp");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDObjetivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDObjetivo().setVisible(true);
            }
        });
    }
