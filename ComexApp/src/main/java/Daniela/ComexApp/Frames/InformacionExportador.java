 ...
 * 
 */
public class InformacionExportador extends javax.swing.JFrame {

    String exportadorBuscado = "", usuario = "";
    /**
     * Creates new form VerUsuario
     */
    public InformacionExportador() {
        initComponents();
        ...
        exportadorBuscado = textExportadorBuscado.getText().trim();
        
        setTitle("Informacíón completa del exportador " + exportadorBuscado + " - Sistema ComexApp");
        jLabelTitulo.setText("Información completa del exportador " + exportadorBuscado);
    ...
    private void initComponents() {
        ...
        textExportadorBuscado = new javax.swing.JTextField();
        ...
        jButtonModificar.setText("Modificar exportador");
        ...
        jButtonEliminar.setText("Eliminar exportador");
        ...
        jButtonBuscar.setText("Buscar exportador");
        ...
        textExportadorBuscado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textExportadorBuscadoActionPerformed(evt);
            }
        });
        jPanelMenu.add(textExportadorBuscado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 217, 33));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/contein.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 410, 230, 187));
    ...
    private void jButtonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModificarActionPerformed
        ...
        String empleado = textExportadorBuscado.getText().trim();
        ...
        try{        
            ...
            exportadoresService.modificarDatosExportador(cuitMod, empleado, empleadoMod,
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        ...
        try{
            Boolean aprobarEliminar = exportadoresService.eliminarExportador(empleado, id);
            ...
            JOptionPane.showMessageDialog(null, "No pudimos eliminar al exportador");
        }
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
        ...
        recepcion = exportadoresService.registroDeExportador(ID, cuit, empleado, 
    ...
    private void jButtonInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInfoActionPerformed
        ...
        InformacionIDExportadores informacionIDExportadores = new InformacionIDExportadores();
        informacionIDExportadores.setVisible(true);

    }//GEN-LAST:event_jButtonInfoActionPerformed

    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed

       exportadoresService.obtenerDatosDelExportador(textExportadorBuscado, 
       ...
       setTitle("Informacíón completa de " + exportadorABuscar + " - Sistema ComexApp");
       jLabelTitulo.setText("Información completa de " + exportadorABuscar + "");
  
    }//GEN-LAST:event_jButtonBuscarActionPerformed

    private void textExportadorBuscadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textExportadorBuscadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textExportadorBuscadoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionExportador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionExportador().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField textExportadorBuscado;
