 ...
 * @author Daniela
 */
public class InformacionIDContenedor extends javax.swing.JFrame {

    /**
     * Creates new form InformacionIDContenedor
     */
    public InformacionIDContenedor() {
        initComponents();
        ...
        setTitle("ID´s contenedores - sistema ComexApp");
         
        
        String sql = "select id_contenedor from contenedores order by id_contenedor asc";
        cargarTablaIDs(sql);
    }
    ...
    public void cargarTablaIDs(String sql){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacionIDContenedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionIDContenedor().setVisible(true);
            }
        });
    }
